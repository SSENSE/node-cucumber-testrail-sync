...
console.log('debug1', process.env.PUSH_RESULTS_TO_TESTRAIL, typeof process.env.PUSH_RESULTS_TO_TESTRAIL)
console.log('debug2', process.env.PUSH_RESULTS_TO_TESTRAIL, Boolean(process.env.PUSH_RESULTS_TO_TESTRAIL))
console.log('debug3', process.env)
